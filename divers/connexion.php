...
$db="romaincarrette"; // le nom de votre base de données.
            // A l IUT, 3 possibilité prenomnom prenomnom1... 

$user="romain.carrette"; // nom d utilisateur pour se connecter
              // A l iut prenom.nom	

$passwd="01/01/1993"; // mot de passe de l utilisateur pour se connecter
